...
const TAG_OPTIONS = ["일반단어", "줄임말", "유행어","신조어", "속어","비속어", "성적용어", "주식","힙합", "게임", "배그", "롤", "속담", "SNS"]

const successMessages = [
  "단어 추가 완료! 이제 밈 역사에 한 획을 그었다 🖋️",
  "ㅋㅋ 이 단어는 이제 영원히 기록된다",
  "신조어 학계에 격변을 일으켰습니다 📚",
  "이 단어, 레전드다 ㄹㅇ",
  "고인물이 하나 더 늘었습니다 🎖️",
  "님 덕분에 오늘도 ㅋㅋ백과가 풍성해졌어요 🙇",
  "밈 전문가 인증 완료 🧠",
  "ㅋㅋ 이거 누가 올렸냐고? (당신)",
  "다음 세대도 이 단어로 웃게 될 거예요",
  "이건 그냥 문화유산임",
  "단어 추가 감사합니다~ 제작진 울고 갑니다 😭",
  "제안 완료! 당신은 지금 역사 속에 이름을 남겼습니다",
  "ㅋㅋ 이거 진짜 쓸모없는데 웃기다 인정",
  "단어 추가하면 복 받습니다 🙏",
  "고생했어요! 이제 단어 퍼질 일만 남았네요",
  "너무 신박해서 AI가 감탄했음",
  "이런 단어... 인간만이 만들 수 있다",
  "언어의 자유를 외치는 위대한 손길 ✊",
  "진지하게... 이거 국어사전에 넣자",
  "단어 한 줄에 웃음이 터졌습니다 ㅋㅋㅋㅋ",
]
